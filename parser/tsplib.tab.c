...
#line 37 "parser/tsplib.tab.c" // lalr1.cc:398
...
#line 51 "parser/tsplib.tab.c" // lalr1.cc:406
// Unqualified %code blocks.
#line 30 "parser/tsplib.y" // lalr1.cc:407

# include "tsplib_driver.h"

#line 57 "parser/tsplib.tab.c" // lalr1.cc:407
...
namespace yy {
#line 143 "parser/tsplib.tab.c" // lalr1.cc:473
...
#line 50 "parser/tsplib.y" // lalr1.cc:616
        { yyoutput << yysym.value.template as< std::string > (); }
#line 314 "parser/tsplib.tab.c" // lalr1.cc:616
        break;
...
#line 321 "parser/tsplib.tab.c" // lalr1.cc:616
        break;
...
#line 50 "parser/tsplib.y" // lalr1.cc:616
        { yyoutput << yysym.value.template as< int > (); }
#line 328 "parser/tsplib.tab.c" // lalr1.cc:616
        break;
  ...
  tsplib_parser::parse ()
  {
    ...
    #line 21 "parser/tsplib.y" // lalr1.cc:726
{
  // Initialize the initial location.
  yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 452 "parser/tsplib.tab.c" // lalr1.cc:726
    ...
    try
      {
        switch (yyn)
          {
  case 2:
#line 54 "parser/tsplib.y" // lalr1.cc:846
    { driver.result = yystack_[0].value.as< int > (); }
#line 573 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 3:
#line 57 "parser/tsplib.y" // lalr1.cc:846
    {}
#line 579 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 4:
#line 58 "parser/tsplib.y" // lalr1.cc:846
    {}
#line 585 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 5:
#line 61 "parser/tsplib.y" // lalr1.cc:846
    { driver.variables[yystack_[2].value.as< std::string > ()] = yystack_[0].value.as< int > (); }
#line 591 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 6:
#line 66 "parser/tsplib.y" // lalr1.cc:846
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () + yystack_[0].value.as< int > (); }
#line 597 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 7:
#line 67 "parser/tsplib.y" // lalr1.cc:846
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () - yystack_[0].value.as< int > (); }
#line 603 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 8:
#line 68 "parser/tsplib.y" // lalr1.cc:846
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () * yystack_[0].value.as< int > (); }
#line 609 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 9:
#line 69 "parser/tsplib.y" // lalr1.cc:846
    { yylhs.value.as< int > () = yystack_[2].value.as< int > () / yystack_[0].value.as< int > (); }
#line 615 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 10:
#line 70 "parser/tsplib.y" // lalr1.cc:846
    { std::swap (yylhs.value.as< int > (), yystack_[1].value.as< int > ()); }
#line 621 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 11:
#line 71 "parser/tsplib.y" // lalr1.cc:846
    { yylhs.value.as< int > () = driver.variables[yystack_[0].value.as< std::string > ()]; }
#line 627 "parser/tsplib.tab.c" // lalr1.cc:846
    break;

  case 12:
#line 72 "parser/tsplib.y" // lalr1.cc:846
    { std::swap (yylhs.value.as< int > (), yystack_[0].value.as< int > ()); }
#line 633 "parser/tsplib.tab.c" // lalr1.cc:846
    break;


#line 637 "parser/tsplib.tab.c" // lalr1.cc:846
          default:
            break;
          }
      }
...
#line 1016 "parser/tsplib.tab.c" // lalr1.cc:1156
#line 73 "parser/tsplib.y" // lalr1.cc:1157
